...
- others (later, for Grails-2.3.x or higher):
	...
	- in the test webapp, do some cleanup inside Bootstrap, moving some things in one (or more) BootstrapHelper class ...
	- in the test webapp, align AkkaController (and maybe even AkkaService) to Servlet 3.0 Asynchronous Rendering ...
