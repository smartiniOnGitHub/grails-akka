...
- for release 1.0:
	...
	- in the test webapp, create an AkkaController to show some akkaSystem info ...
	- in akkaService (transactional false), make akkaSystem static final and read-only, and use lifecycle annotations like seen here: ...
https://jira.grails.org/browse/GRAILS-10137
	...
	- use akkaService directly from a sample Controller in the test webapp and ask for akkaSystem (maybe hiding it) ...
	- (optional) add base class for actor messages (from Akka best practices), and add other sample messages ...
    - fix TODO in plugin ...
...
- later:
	...
	- in the test webapp, improve AkkaController to show more akkaSystem info ...
