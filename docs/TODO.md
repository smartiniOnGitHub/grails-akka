...
- for 2.3.9_2.10 (update to latest Akka, the version for Scala-2.10.x):
* Later 2015
** 2.3.9_2.10 release
*** Updated to Akka-2.3.9 (aligned with Scala-2.10.4)

- create another maintenance branch for 2.3.x_2.10, and set 2.3.x_2.11 in master ...


- later:
	- update dependencies to Akka-2.3.9 or later (but stay on Scala-2.10.x for now) ...
	- check if set a new plugin release as 2.3.9 or 2.3.9_2.10 (like in the Scala world), and then make even a _2.11 release (and update plugin page with this info) ...
